...
![Microsoft Windows]({filename}/images/OS/windows.png)
  ...
  * Download the [latest Windows installer for darktable](https://github.com/darktable-org/darktable/releases/download/release-2.6.2/darktable-2.6.2-win64.exe).
...
![macosx]({filename}/images/OS/macosx.jpg)
  ...
  * Download the [latest DMG disk image for darktable](https://github.com/darktable-org/darktable/releases/download/release-2.6.2/darktable-2.6.2.dmg)
  * Mount the thing
...
* Grab the [latest source tarball](https://github.com/darktable-org/darktable/releases/tag/release-2.6.2) (recent version: darktable 2.6.2)&nbsp;– make sure to use the .tar.xz file and not the auto generated .zip or .tar.gz!
* Install the dependencies. For details see the link below.
* Unpack:

        $ tar xvf darktable-2.6.2.tar.xz && cd darktable-2.6.2
