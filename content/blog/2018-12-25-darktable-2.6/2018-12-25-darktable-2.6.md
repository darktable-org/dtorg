...
contrast. IOW, with a positive contrast, parts of the image below the
fulcrum will be darkened and parts above it will have their luminance
increased:
...
*unbreak input profile* module is now equiped with a logarithmic mode,
...
That is indeed the point: it is meant to be used in conjunction with
...
colorbalance allows for example this:
