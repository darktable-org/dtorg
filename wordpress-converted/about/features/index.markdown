...
author: smn
comments: false
date: 2011-07-09 08:37:56+00:00
layout: page
link: http://www.darktable.org/about/features/
slug: features
title: features
wordpress_id: 84
---

These are some of darktable's current features, and a coarse overview over the current image operation modules. You can find a more detailed description of every single item in our [online user manual](http://www.darktable.org/usermanual/index.html.php).

![](http://www.darktable.org/wp-content/uploads/2011/07/gold.jpg)
...
![](http://www.darktable.org/wp-content/uploads/2011/07/moon.jpg)
...
## Tone image operations:
  ...
  * tone curve: This module is a classical tool in digital photography. You can change the lightness by dragging the line up or down. darktable let you separately control the L, a and b channel. Read in [Ulrich's blog post](http://www.darktable.org/2012/02/mastering-color-with-lab-tone-curves/) how to make use of this feature.
...
## Color image operations:
  ...
  * color contrast
  * color correction: This module can be used to modify the global saturation or to give a tint. Read [Johannes' blog post](http://www.darktable.org/2012/03/color-correction/).
  ...
  * vibrance: For a detailed description read [Henrik's blog post](http://www.darktable.org/2011/10/different-kind-of-saturation/).
...
## Correction modules:
  ...
  * lens correction: lens defect correction using [lensfun](http://lensfun.berlios.de/).
  ...
  * raw denoise: Raw denoise allows you to perfom denoising on pre-demosaic data. It is ported from [dcraw](http://www.cybercom.net/~dcoffin/dcraw/).
...
## Effects/artistic image postprocessing:
  ...
  * lowpass: This module acts as lowpass filter. One use case is described in [Ulrich's blog post](http://www.darktable.org/2012/02/using-lowpass-filter-to-recover-shadows/).
  ...
  * shadows and highlights: Improve images by lightening shadows and darkening highlights. Read [Ulrich's blog post](http://www.darktable.org/2012/02/shadow-recovery-revisited/) on this.
