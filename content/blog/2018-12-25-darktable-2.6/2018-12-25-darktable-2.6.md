...
contest):
  ...
  <div style="text-align: center">
  ![]({filename}cb-split-toning.jpg)
  </div>

In this example, the cursors have been pushed a bit far to get a clear
effect, but the module can also produce more subtle effects. See for
example the "orange and teal" presets added to the module in this
