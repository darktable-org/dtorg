...
darktable currently does not have AI-based object/subject selection, so you will
...
![path](path-button.png#icon) tool.  It is preferable to be slightly
_inside_ the edge of the object.
...
Version 5.2 added a new _external raster masks_ module which allows
importing masks generated by other programs.  There is likely to be a
plugin script to integrate AI mask generation using this module by the
end of 2025.
