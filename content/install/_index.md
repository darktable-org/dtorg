...
<p class="chooseos">
<a href='#ubuntu' title='Ubuntu'><img class='chooseos' alt="ubuntu" src="/images/OS/ubuntu.jpg"></a>
<a href='#fedora' alt='Fedora'><img class='chooseos' alt="fedora" src="/images/OS/fedora.jpg"></a>
<a href='#opensuse' title='openSUSE'><img class='chooseos' alt="opensuse" src="/images/OS/opensuse.jpg"></a>
<a href='#arch' title='Arch'><img class='chooseos' alt="arch" src="/images/OS/arch.jpg"></a>
<a href='#gentoo' title='Funtoo/Gentoo'><img class='chooseos' alt="gentoo" src="/images/OS/gentoo.jpg"></a>
<a href='#rhel' title='RHEL 6 / SL 6 / CentOS 6'><img class='chooseos' alt="macosx" src="/images/OS/scientificlinux.jpg"></a>
<a href='#macos' title='macOS'><img class='chooseos' alt="macosx" src="/images/OS/macosx.jpg"></a>
<a href='#debian' title='Debian'><img class='chooseos' alt="debian" src="/images/OS/debian.png"></a>
<a href='#solaris' title='Solaris'><img class='chooseos' alt="opensolaris" src="/images/OS/opensolaris.png"></a>
<a href='#freebsd' title='FreeBSD'><img class='chooseos' alt="freebsd" src="/images/OS/freebsd.png"></a>
<a href='#windows' title='Microsoft Windows'><img class='chooseos' alt="windows" src="/images/OS/windows.png"></a>
</p>
...
![leaves1](/images/OS/leaves1.jpg)

* Grab the [latest source tarball](https://github.com/darktable-org/darktable/releases/download/release-3.4.1/darktable-3.4.1.tar.xz) (recent version: darktable 3.4.1)&nbsp;– make sure to use the .tar.xz file and not the auto generated .zip or .tar.gz!
* Install the dependencies. For details see the link below.
* Unpack:

        $ tar xvf darktable-3.4.1.tar.xz && cd darktable-3.4.1
