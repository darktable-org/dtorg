...
give more natural results. It considers pixels individually, without
...
"filmic" is meant to be used as a replacement for the "base curve"
...
saturation in the shadows and highlights to avoid this.
