...
*Compressed LUT* files have been created by the G'MIC team (see [Pixls.us - CLUT compression](https://discuss.pixls.us/t/clut-compression/11752)) which offers a ready use library (gmic_cluts.gmz).
...
* To renove a *Compressed LUT* from a gmz library:
`gmic -i <libraryname>.gmz -remove[<lutname>] -o library.gmz{}`
